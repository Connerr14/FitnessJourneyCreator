...
namespace FitnessJourneyCreator.Controllers
{
    public class MacrocyclesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MacrocycleId,StartDate,EndDate,Description,WorkoutPlanId")] Macrocycle macrocycle)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MacrocycleId,StartDate,EndDate,Description,WorkoutPlanId")] Macrocycle macrocycle)
        {
